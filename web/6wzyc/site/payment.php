            ...
            <div class="panel cream">
                ...
                <div id="step-one" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <p>You will currently be charged NZD <strong>$1,395</strong> per person (3.25% transaction charge inclusive).</p>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%">
                                                <tr>
                                                    <td align="center" style="border: none;">
                                                        <input style="cursor:pointer; color:#fff; text-decoration: none; font-family:'Arial', 'Helvetica', sans-serif; font-size: 14px; font-weight: bold; border: none; background-color: #9FBF00;" type="submit" id="submit" value="Pay Now!!" name="submit"><input type="hidden" id="product_id" name="product_id" value="68119D87E106">
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
            ...
            <div class="panel light-green">
                ...
                <div id="step-two" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <p>You will currently be charged NZD <strong>$1,405</strong> per person (3.25% transaction charge inclusive).</p>
                        <p>Please enter the number of delegates you will be paying for (if you are paying for more than one person) and click the 'Pay Now' button. You will be redirected to the payment portal.</p>
                                    ...
                                    <td>
                                        <div style="width:95px; height:30px; border: thin solid grey; background-color: #9FBF00; text-align: center; border-radius: 9px; cursor: pointer;">
                                            <table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%">
                                                <tr>
                                                    <td align="center" style="border: none;">
                                                        <input style="cursor:pointer; color:#fff; text-decoration: none; font-family:'Arial', 'Helvetica', sans-serif; font-size: 14px; font-weight: bold; border: none; background-color: #9FBF00;" type="submit" id="submit" value="Pay Now!!" name="submit"><input type="hidden" id="product_id" name="product_id" value="EB92C17408D16">
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
            ...
            <div class="panel ice-blue">
                ...
                <div id="step-three" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <ul>
                            <li>Total amount to pay: <strong>NZD $1374</strong></li>
